...
import { Activity, Users, TrendingUp, TrendingDown, Target, Calendar, Loader2 } from 'lucide-react';
...
export default function ProductTab() {
  ...
  const dataTableColumns = [
    ...
    { id: 'dau', label: 'DAU', editable: true, format: formatNumber },
    { id: 'wau', label: 'WAU', editable: true, format: formatNumber },
    { id: 'mau', label: 'MAU', editable: true, format: formatNumber },
    { id: 'activationRate', label: 'Activation %', editable: true, format: formatPercent },
  ];
  ...
  const metricConfigs = [
    { id: 'dau', title: 'Daily Active Users', color: '#3B82F6', bgColor: '#DBEAFE', format: formatNumber, icon: Users },
    { id: 'wau', title: 'Weekly Active Users', color: '#8B5CF6', bgColor: '#EDE9FE', format: formatNumber, icon: Users },
    { id: 'mau', title: 'Monthly Active Users', color: '#10B981', bgColor: '#D1FAE5', format: formatNumber, icon: Users },
    { id: 'activationRate', title: 'Activation Rate', color: '#F59E0B', bgColor: '#FEF3C7', format: formatPercent, icon: Activity },
  ];
          ...
          return (
            <div key={config.id} style={styles.metricCard}>
              ...
              <div style={styles.metricGoal}>
                <Target size={14} />
                <span>Goal: {config.format(goal)}</span>
